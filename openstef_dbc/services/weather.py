    ...
    def _combine_weather_sources(
        ...
        Args:
            ...
            source_order (list): which weather models should be used (first).
                ...
                Default: '"harm_arome", "harmonie", "DSN", "icon"'. This combines harmonie, harm_arome, DSN and ICON,
        ...
        if source_order is None:
            source_order = ["harm_arome", "GFS_50", "harmonie", "DSN", "icon"]
    ...
    def get_weather_data(
        ...
        Args:
            ...
            source (str or list of str): which weather models should be used.
                ...
                Default: 'optimum'. This combines harmonie, harm_arome, DSN and icon,
                taking the (heuristicly) best available source for each moment in time
        ...
        if "optimum" in source:
            ...
            source = ["harm_arome", "GFS_50", "harmonie", "DSN", "icon"]
